...
Practical, extended playlist with design inspirations
I recommend this YouTube account for general Web Design tips
https://www.youtube.com/watch?v=nZ2BJt9PgKE&list=PLq7GcFt99FA6AA4QZfieEA5H7uzRNhbX4

Quick, mobile-focused
https://www.youtube.com/watch?v=FhGdLUW_8S0

Slow-paced interface walk-through
https://www.youtube.com/watch?v=hYu69kgxmLg

2. Optionally:
3-hr Figma crash course which I found helpful (please note following it with pauses will take longer):
https://www.youtube.com/watch?v=QJBP2uy8LcU

3. Main part:
Start designing the main page of your portfolio website using Figma. For this task, use a column system. The final version of your website does not need to be based on columns if you don't want it to be. The homework submission for this week needs to be based on columns.

For the final assessment, please include a public link to the Figma board.
Optional video on design tips: https://www.youtube.com/watch?v=rRFD6tENX2U 

<h2> WEEK 5 </h2>
Continue working on your website. Before next week, make sure you:
- have a basic design for your main page.
- know if the rest of the information will be separate pages or sections, and have these planned.
- have picked fonts, text sizes, and a main colour palette.
- You have at least 2 colour modes (light / dark). Optionally, there could be more, for example high-contrast.
- Your have designed the layout for at least 3 different screen widths, and ideally (refer to last weeks' resources).
- You have integrated up-to-date homeworks in the website prototype.

<h2> WEEK 6 </h2>
Website that changes with time
design a webpage that functions as a clock. Think about creative ways to represent time - through colors, shapes, typography, or abstract elements.
...
Use JavaScript to manipulate the DOM and update your clock.

Further: Take it a step further - make a website that gradually changes over time. Consider how time itself can become a creative element in web design.
...
<h2> WEEK 10 </h2>
<img src="<img width="966" height="386" alt="Screenshot 2025-12-11 at 15 06 34" src="https://github.com/user-attachments/assets/2466d846-629d-4dec-a91e-0ff81623288d" alt="taskweek10" /> <br><br>
<img src="<img width="950" height="796" alt="Screenshot 2025-12-11 at 15 06 42" src="https://github.com/user-attachments/assets/9ca5ee80-59a3-499a-96d4-4617e4c9d080" alt="taskweek10" />
